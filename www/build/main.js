...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/home/ein/Documentos/cdt/urg/urgmaps-m/urgmaps-mobile/src/app/app.html"*/'<ion-menu persistent = \'true\' id=\'menu\' side="right"  [content]="mycontent">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content class="menu">\n    <ion-list>\n      <!-- <ion-item (click)="getDataLoginUser()" menuClose >Cerrar Sesión</ion-item> -->\n\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)" >\n        {{p.title}}\n      </button>\n\n    </ion-list>\n  </ion-content>\n</ion-menu>\n\n<ion-nav #mycontent [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/home/ein/Documentos/cdt/urg/urgmaps-m/urgmaps-mobile/src/app/app.html"*/
        }),
